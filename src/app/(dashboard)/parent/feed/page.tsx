...
export default function ParentHomePage() {
  ...
  const fetchPosts = async () => {
    ...
    setIsLoading(true);
    try {
      // Parents fetch from the same public tuitions list
  ...
  return (
    <div className="max-w-2xl mx-auto py-6 px-4 pb-24">
      <div className="mb-8">
        <h1 className="text-2xl font-black text-text-main">Marketplace</h1>
        <p className="text-text-muted text-sm font-medium">
          See what other parents are posting and keep up with market rates.
        </p>
      </div>
